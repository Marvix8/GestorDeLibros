 ...
 */
public class VentanaLibrosOld extends JFrame {
	/**
	 ...
	 */
	public VentanaLibrosOld(final Vector<Libro> listaLibros) {
		setAlwaysOnTop(true);
		...
		contentPane.add(listLibrosDisplay);

		JPanel panel = new JPanel();
		contentPane.add(panel);
		GridBagLayout gbl_panel = new GridBagLayout();
		gbl_panel.columnWidths = new int[] { 59, 0, 0, 0, 0 };
		gbl_panel.rowHeights = new int[] { 21, 0, 0, 0, 0, 0, 0 };
		...
		panel.add(lblTituloDisplay, gbc_lblTituloDisplay);
		...
		panel.add(lblAutorDisplay, gbc_lblAutorDisplay);
		...
		panel.add(lblEdicionDisplay, gbc_lblEdicionDisplay);
		...
		panel.add(lblAnoPublicacionDisplay, gbc_lblAnoPublicacionDisplay);

		this.lblAnoPublicacion = new JLabel();
		GridBagConstraints gbc_lblAnoEdicion = new GridBagConstraints();
		gbc_lblAnoEdicion.gridwidth = 3;
		...
		panel.add(lblAnoPublicacion, gbc_lblAnoEdicion);
		...
		panel.add(lblEditorialDisplay, gbc_lblEditorialDisplay);
